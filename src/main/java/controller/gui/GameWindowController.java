...
public class GameWindowController {
    ...
    void onAction(ActionEvent event) {
        gameController.handleNextPhase();
    }
    ...
    public String showSelectMarkerAlert() {
        ...
        List<ButtonType> buttonTypes = new ArrayList<>();
        GameInfo.getAllSelectionMarkers().stream().filter(Marker::isAvailable).forEach(
...
//
//        List<ButtonType> buttonTypes = new ArrayList<>();
//        gameController.getActionList().stream().filter(Action::isActionAvailable).forEach(
